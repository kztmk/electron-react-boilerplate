...
import domains from './data/ninjya';
...
/**
 * blogAccount自動取得時の忍者ブログ追加情報フォーム
 */
class StepNinjya extends React.Component<Props, State> {
  constructor(props) {
    super(props);
...
export default withStyles(extendedFormsStyle)(StepNinjya);
