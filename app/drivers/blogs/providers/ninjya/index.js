...
/**
 * blog provider for [Ninjya](https://www.ninja.co.jp/).
 *
 * @extends BlogProvider
 */
class BlogProviderNinjya extends BlogProvider {
  /**
...
export default BlogProviderNinjya;
