...
/**
 * blog provider for [WordPress.com](https://ja.wordpress.com/).
 *
 * @extends BlogProvider
 */
class BlogProviderWpcom extends BlogProvider {
  /**
   ...
   * @param {string} blogInfo.accountId - Username for WordPress.com
...
export default BlogProviderWpcom;
