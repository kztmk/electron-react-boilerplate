...
export const GET_BLOGS_REQUEST: 'BlogList/GET_BLOGS_REQUEST' = 'BlogList/GET_BLOGS_REQUEST';
export const GET_BLOGS_SUCCESS: 'BlogList/GET_BLOGS_SUCCESS' = 'BlogList/GET_BLOGS_SUCCESS';
export const GET_BLOGS_FAILURE: 'BlogList/GET_BLOGS_FAILURE' = 'BlogList/GET_BLOGS_FAILURE';
export const CREATE_BLOG_REQUEST: 'BlogList/CREATE_BLOG_REQUEST' = 'BlogList/CREATE_BLOG_REQUEST';
export const CREATE_BLOG_SUCCESS: 'BlogList/CREATE_BLOG_SUCCESS' = 'BlogList/CREATE_BLOG_SUCCESS';
export const CREATE_BLOG_FAILURE: 'BlogList/CREATE_BLOG_FAILURE' = 'BlogList/CREATE_BLOG_FAILURE';
export const UPDATE_BLOG_REQUEST: 'BlogList/UPDATE_BLOG_REQUEST' = 'BlogList/UPDATE_BLOG_REQUEST';
export const UPDATE_BLOG_SUCCESS: 'BlogList/UPDATE_BLOG_SUCCESS' = 'BlogList/UPDATE_BLOG_SUCCESS';
export const UPDATE_BLOG_FAILURE: 'BlogList/UPDATE_BLOG_FAILURE' = 'BlogList/UPDATE_BLOG_FAILURE';
export const DELETE_BLOG_REQUEST: 'BlogList/DELETE_BLOG_REQUEST' = 'BlogList/DELETE_BLOG_REQUEST';
export const DELETE_BLOG_SUCCESS: 'BlogList/DELETE_BLOG_SUCCESS' = 'BlogList/DELETE_BLOG_SUCCESS';
export const DELETE_BLOG_FAILURE: 'BlogList/DELETE_BLOG_FAILURE' = 'BlogList/DELETE_BLOG_FAILURE';
